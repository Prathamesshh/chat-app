...
import { useAuthStore } from "../store/useAuthStore.js"; // adjust path if needed
...
const SignUpPage = () => {
  ...
  // ✅ Renamed `fullname` to `fullName`
  const [formData, setFormData] = useState({
    fullName: "", // ✅ Match the backend field name
    email: "",
    password: "",
  });
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={formData.fullName} // ✅ fixed here
